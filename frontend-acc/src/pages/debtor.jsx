...
function Debtor() {
  ...
  useEffect(() => {
    async function fetchDebtorData() {
      try {
        const response = await axios.get('https://accounts.back.opsdemo.xyz/api/viewcredits');
    ...
    async function fetchCustomerDropdown() {
      try {
        const response = await axios.get('https://accounts.back.opsdemo.xyz/api/customers-dropdown');
  ...
  const handleSubmit = async (event) => {
    ...
    if (formData && formData.entries) { // Check if formData is iterable
      ...
      try {
        await axios.post('https://accounts.back.opsdemo.xyz/api/addcredit', data);
        ...
        axios.get('https://accounts.back.opsdemo.xyz/api/viewcredits')
          .then(response => {
            setDebtorData(response.data);
          })
          .catch(error => {
  ...
  const handleDelete = (creditId) => {
    axios.delete(`https://accounts.back.opsdemo.xyz/api/deletecredit/${creditId}`)
      .then(response => {
