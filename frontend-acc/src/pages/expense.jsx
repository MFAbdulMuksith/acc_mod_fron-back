...
function Expense() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post('https://accounts.back.opsdemo.xyz/api/expense', { date, description, amount });
      toast.success('Expense added Successfully!!');
      setDate('');
      setDescription('');
      setAmount('');
      axios.get('https://accounts.back.opsdemo.xyz/api/expenselist')
        .then(response => {
  ...
  const handleDelete = (id) => {
    ...
    axios.delete(`https://accounts.back.opsdemo.xyz/api/removeexpense/${id}`)
      .then(response => {
