...
function AddUser() {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('https://accounts.back.opsdemo.xyz/api/data', userData)
            .then(response => {
                ...
                setPassword('');
                setrePassword('');
                axios.get('https://accounts.back.opsdemo.xyz/api/data')
                    .then(response => {
    ...
    const handleDelete = (id) => {
        ...
        axios.delete(`https://accounts.back.opsdemo.xyz/api/data/${id}`)
            .then(response => {
