...
function Customer() {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('https://accounts.back.opsdemo.xyz/api/addcustomer', customerData)
            .then(response => {
                ...
                setCusMob('');
                setCusCode('');
                axios.get('https://accounts.back.opsdemo.xyz/api/viewcustomers')
                    .then(response => {
    ...
    const handleDelete = (id) => {
        ...
        axios.delete(`https://accounts.back.opsdemo.xyz/api/removecust/${id}`)
            .then(response => {
