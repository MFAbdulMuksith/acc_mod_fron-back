...
function Lenders() {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('https://accounts.back.opsdemo.xyz/api/add-lender', lenderData)
            .then(response => {
                ...
                axios.get('https://accounts.back.opsdemo.xyz/api/view-lenders')
                .then(response => {
    ...
    const handleDelete = (id) => {
        axios.delete(`https://accounts.back.opsdemo.xyz/api/remove-lenders/${id}`)
        .then(response => {
