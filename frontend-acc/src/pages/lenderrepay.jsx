...
function LenderRepay() {
    ...
    useEffect(() => {
        async function fetchLenders() {
            try {
                const response = await axios.get('https://accounts.back.opsdemo.xyz/api/lenders-dropdown');
    ...
    const handleLenderChange = async (event) => {
        ...
        try {
            const response = await axios.get(`https://accounts.back.opsdemo.xyz/api/lender/lend-amount/${selectedLenderName}`);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            await axios.post('https://accounts.back.opsdemo.xyz/api/lend-repayment', {
