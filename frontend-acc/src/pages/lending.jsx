...
function Lending() {
  ...
  useEffect(() => {
    fetch('https://accounts.back.opsdemo.xyz/api/view-lenders')
  ...
  useEffect(() => {
    axios.get('https://accounts.back.opsdemo.xyz/api/view-lending')
      .then(response => {
  ...
  const handleSubmit = async (event) => {
    ...
    axios.post('https://accounts.back.opsdemo.xyz/api/add-lend', lendingData)
      .then(response => {
  ...
  const handleDelete = (id) => {
    axios.delete(`https://accounts.back.opsdemo.xyz/api/remove-lending/${id}`)
      .then(response => {
