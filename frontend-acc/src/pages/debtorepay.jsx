...
function DebtorRepay() {
  ...
  const fetchDueAmount = async (customerName) => {
    ...
    try {
      const response = await axios.get(`https://accounts.back.opsdemo.xyz/api/customer/history/${customerName}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://accounts.back.opsdemo.xyz/api/credit-repayments', {
        date: creditDate,
