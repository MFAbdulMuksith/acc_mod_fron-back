...
const Home = () => {
  ...
  useEffect(() => {
    const fetchRecentData = async () => {
      try {
        const debtResponse = await axios.get('https://accounts.back.opsdemo.xyz/api/recent-debts');
  ...
  useEffect(() => {
    const fetchRecentLends = async () => {
      try {
        const response = await axios.get('https://accounts.back.opsdemo.xyz/api/recent-lends');
    ...
    const fetchData = async () => {
      try {
        ...
        for (const date of dateArray) {
          ...
          const response = await axios.get(`https://accounts.back.opsdemo.xyz/api/daily-report-details?date=${formattedApiDate}`);
  ...
  const fetchTodayDataFromAPI = async (date) => {
    const response = await fetch(`https://accounts.back.opsdemo.xyz/api/daily-report-details?date=${date}`);
